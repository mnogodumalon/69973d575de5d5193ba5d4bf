...
import { IconArrowBackUp, IconLayoutDashboard, IconMenu2, IconPackage, IconSettings, IconPlayerPlay, IconChevronDown } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Artikel einstellen', href: '/artikel-einstellen', icon: IconPackage },
];

const externalNavigation = [
  { name: 'Artikel einstellen', href: '/gateway/apps/69973d478f87c3d22d5c7258?template=list_page', icon: IconPackage },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69973d478f87c3d22d5c7258?template=list_page"
