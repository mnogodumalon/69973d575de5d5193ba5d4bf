...
export function ArtikelEinstellenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: ArtikelEinstellenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'artikel_einstellen');
      await onSubmit(clean as ArtikelEinstellen['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  const DIALOG_INTENT = defaultValues ? 'Artikel einstellen bearbeiten' : 'Artikel einstellen hinzufügen';
